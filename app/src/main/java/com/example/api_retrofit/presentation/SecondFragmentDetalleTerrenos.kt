 ...
 * Use the [SecondFragmentDetalleTerrenos.newInstance] factory method to
...
class SecondFragmentDetalleTerrenos : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SecondFragmentDetalleTerrenos.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SecondFragmentDetalleTerrenos().apply {
